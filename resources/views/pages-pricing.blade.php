                        ...
                        <div class="card mb-xl-0">
                            <div class="card-body">
                                <div class="p-2">
                                    ...
                                    <p class="text-muted mt-3 font-size-15">For small teams trying out Dashboard for an unlimited
                                        period of time</p>
                    ...
                    <a class="nav-link box-shadow mb-3 active" id="v-pills-tab-one" data-bs-toggle="pill" href="#v-price-one" role="tab" aria-controls="v-price-one" aria-selected="true">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="fw-normal mb-0 text-muted pt-1">For small teams trying out Dashboard for an unlimited period of time</p>
                            </div>
                        </div>
                    </a>
